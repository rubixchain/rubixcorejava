...
IPFS_PATH=~/.ipfs1 ipfs config --json Addresses.Swarm '["/ip4/0.0.0.0/tcp/4001", "/ip6/::/tcp/4001"]'
...
IPFS_PATH=~/.ipfs2 ipfs config --json Addresses.Swarm '["/ip4/0.0.0.0/tcp/4002", "/ip6/::/tcp/4002"]'
...
IPFS_PATH=~/.ipfs3 ipfs config --json Addresses.Swarm '["/ip4/0.0.0.0/tcp/4003", "/ip6/::/tcp/4003"]'
