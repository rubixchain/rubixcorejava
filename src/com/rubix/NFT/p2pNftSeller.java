...
public class p2pNftSeller {
    ...
    public static String receive() {
        ...
        try {
            ...
            nftSellerLogger.info("Received p2pFlag from Buyer " + p2pFlag);
            if (p2pFlag.equals("1")) {
                nftSellerLogger.info("This is a Peer to Peer nft transfer");
