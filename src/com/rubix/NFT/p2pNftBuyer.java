...
public class p2pNftBuyer {
    ...
    public static JSONObject send(String data, IPFS ipfs, int port) {
        ...
        try {
            ...
            String p2pFlag = Integer.toString(detailsObject.getInt("p2pFlag"));
            nftBuyerLogger.debug("Sending flag value to seller");
            output.println();
            if (p2pFlag.equals("1")) {
                nftBuyerLogger.info("This is a Peer to Peer NFT transfer");
                String rbtAmount;
                try {
                ...
                nftBuyerLogger.info("This is a NFT transfer involving central wallet");
            }
