...
public class ReceiveTokenParts {
    ...
    public static String receive() {
        ...
        try {
            ...
            TokenPartReceiverLogger.debug("Part Receiver Listening on " + partFolder + " with app name " + receiverPeerID.concat("parts"));
...
//                        String contentArray = readFile(PART_TOKEN_CHAIN_PATH.concat(tokens).concat(".json"));
...
//                        newPartObject.put("tid", tid);
//                        newPartObject.put("nextHash", "");
//                        newPartObject.put("previousHash", calculateHash(array.getJSONObject(array.length() - 1).getString("tid"), "SHA3-256"));
//                        newPartObject.put("amount", amount);
//                        newPartObject.put("cheque", chequeHash);
//                        newPartObject.put("role", "Receiver");
...
//                        writeToFile(PART_TOKEN_CHAIN_PATH + tokens + ".json", array.toString(), false);
//                    } else {
...
//                        newPartObject.put("tid", tid);
//                        newPartObject.put("nextHash", "");
//                        newPartObject.put("previousHash", calculateHash(new JSONObject().toString(), "SHA3-256"));
//                        newPartObject.put("amount", amount);
//                        newPartObject.put("cheque", chequeHash);
//                        newPartObject.put("role", "Receiver");
