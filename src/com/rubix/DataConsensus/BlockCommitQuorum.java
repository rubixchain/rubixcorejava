...
// public static Logger BlockCommitQuorumLogger =
// Logger.getLogger(BlockCommitQuorum.class);
...
// String temp, peerID, transactionID, verifySenderHash, blockHash, receiverPID,
...
// BlockCommitQuorumLogger.debug("Quorum Listening on " + port + " appname " +
// appName);
...
// // .debug("Sender reqesting QuorumSignedTransactions.json and
// // CreditMapping.json: " + qstReq);
...
// // }
// // JSONArray qstContent = new JSONArray(readFile(WALLET_DATA_PATH +
// // "QuorumSignedTransactions.json"));
// // JSONObject qstObjectSend = new JSONObject();
// // if (qstContent.length() > 0)
// // qstObjectSend = qstContent.getJSONObject(qstContent.length() - 1);

// // String cmFileHash = IPFSNetwork.add(WALLET_DATA_PATH +
// "CreditMapping.json",
// // ipfs);
...
// // TODO: if the incoming request contains the keyword "request", push the QST
// to
...
// senderDidIpfsHash);
// // receiverPID = getValues(DATA_PATH + "DataTable.json", "peerid", "didHash",
// // blockHash);

// String senderWidIpfsHash = getValues(DATA_PATH + "DataTable.json",
// "walletHash", "didHash",
// senderDidIpfsHash);

// nodeData(senderDidIpfsHash, senderWidIpfsHash, ipfs);
// String quorumHash = calculateHash(verifySenderHash.concat(blockHash),
// "SHA3-256");
...
// // BlockCommitQuorumLogger.debug("Checking providers for: " +
// verifySenderHash);
...
// // TODO: verifying the block hash, fetching block hash and pinning files in
// // block file.
...
// String QuorumSignature = getSignFromShares(DATA_PATH + didHash +
// "/PrivateShare.png",
// quorumHash);
...
// if (!creditval.equals("null")) { // commented as per test for multiple
// consensus threads

// FileWriter shareWriter = new FileWriter(new File(LOGGER_PATH +
// "mycredit.txt"), true);
...
// writeToFile(WALLET_DATA_PATH + "CreditMapping.json",
// creditMappingArray.toString(),
// false);
...
// // ? During mining if QST file has blockHash instead of recieverID, then
// credit
// // is counted as 2 for that transaction.
...
// String consenusIDhash = IPFSNetwork.add(LOGGER_PATH + "consenusIDhash",
// ipfs);
...
// JSONArray blockArray = new
// JSONArray(blockDataObject.getJSONObject("metadata"));
